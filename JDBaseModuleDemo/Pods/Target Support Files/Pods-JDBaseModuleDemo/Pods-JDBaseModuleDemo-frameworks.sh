...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/JDBaseModule/JDBaseModule.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/JDNetWorkManager/JDNetWorkManager.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/JDragonNetWork/JDragonNetWork.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/JDragonTableManager/JDragonTableManager.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SUIMVVMKit/SUIMVVMKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SUIUtils/SUIUtils.framework"
